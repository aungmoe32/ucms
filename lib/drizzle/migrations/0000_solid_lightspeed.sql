...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "teacher_semester" ADD CONSTRAINT "teacher_semester_teacher_id_teachers_id_fk" FOREIGN KEY ("teacher_id") REFERENCES "public"."teachers"("id") ON DELETE no action ON UPDATE no action DEFERRABLE INITIALLY DEFERRED;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "teacher_semester" ADD CONSTRAINT "teacher_semester_semester_id_semesters_id_fk" FOREIGN KEY ("semester_id") REFERENCES "public"."semesters"("id") ON DELETE no action ON UPDATE no action DEFERRABLE INITIALLY DEFERRED;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
